...
INSERT INTO turnos (nome_turno, horario_inicio, horario_fim)
VALUES 
('Manhã (Seg-Sex)', '07:00:00', '12:00:00'),
('Tarde (Seg-Sex)', '13:00:00', '16:45:00'),
('Livre (Seg-Sex)', '16:45:00', '22:00:00'),
('Manhã (Sábado)', '07:00:00', '12:00:00'),
('Tarde (Sábado)', '13:00:00', '16:45:00'),
('Livre (Sábado)', '16:45:00', '18:00:00');
...
INSERT INTO reservasadmin (data_hora_inicio, data_hora_fim, status_reserva, nome_adm, id_sala) 
VALUES 
('2024-11-28 09:00:00', '2024-11-28 10:00:00', 'Confirmada', 'Admin@gmail.com', 1);
...
ORDER BY 
    ...
    CREATE VIEW reservas_ultima_semana_docente AS
SELECT 
    r.id_reserva,
    d.email_doc ,
    r.data_hora_inicio,
...
FROM 
    reservas r
JOIN 
    docentes d ON r.email_doc = d.email_doc
WHERE 
    DATE(r.data_hora_inicio) >= CURDATE() - INTERVAL 7 DAY
    AND DATE(r.data_hora_inicio) < CURDATE()
ORDER BY 
